    ...
    return (
        <section id="contact" className="py-24 px-4 sm:px-6 lg:px-8 bg-background">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-background rounded-2xl p-8 sm:p-12 shadow-sm border border-foreground/10 max-w-2xl mx-auto overflow-hidden">
                    <div className="grid">

                        <div
                            className={`col-start-1 row-start-1 flex flex-col items-center justify-center transition-all duration-500 ease-in-out ${isSubmitted
                        ...
                        <div
                            className={`col-start-1 row-start-1 transition-all duration-500 ease-in-out ${!isSubmitted
                                ? "opacity-100 translate-y-0 visible z-10"
                                : "opacity-0 -translate-y-4 invisible -z-10"
                                }`}
                        >
